...
def copy() -> None:
    ...
    copy_1 = tk.Tk()
    copy_1.withdraw()
    copy_1.clipboard_clear()
    if mode == 0:
        copy_1.clipboard_append(string_for_copy)
    elif mode == 1:
        copy_1.clipboard_append(key)
    copy_1.update()
    copy_1.destroy()
...
def start() -> None:
    ...
    b4_copy = tk.Button(out, text="press for copy", command=copy_string())
    b5_copy = tk.Button(out, text="press for copy", command=copy_key())
